  ...
  return (
    <div className={styles.chatHeader}>
      <div className={styles.headerInfo}>
        ...
        <div>
          <div className={styles.headerTitle}>LLM Chatbot to Reoptimize Route</div>
      ...
      <div className={styles.headerActions}>
        <button onClick={onReset} className={styles.headerBtn}
          aria-label="Reset Conversation History" title="Reset Conversation"
        >
          <RefreshCw size={14} />
        </button>
        <button onClick={onClose} className={styles.headerBtn}
          aria-label="Minimize Chatbot Window" title="Minimize Chatbot"
        >
          <X size={16} />
        </button>
      </div>
