...
- Exposes get_active_checkpoint_path() for UniversalPeMSAdapter serving
"""
...
def get_active_checkpoint(dataset_name: str) -> str:
    ...
    if active_v and active_v in ds_reg.get("versions", {}):
        pt_path = ds_reg["versions"][active_v].get("pt_path")
        if pt_path and os.path.exists(pt_path):
            return pt_path
    
    # Fallback to standard base checkpoint path
