  ...
  "cells": [
    {
      ...
      "source": [
        ...
        "3. **Physics-Informed Custom Loss**: Bottleneck severity penalty ($\alpha, \beta$) from `model_config.yaml`.\n",
...
with open("colab_export/EquiTraffic_GWNet_Training.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2)

print("[+] EquiTraffic_GWNet_Training.ipynb generated successfully!")
